...
--
-- Live DB note: 0024_chest_number_gender_order.sql (renumber_chest_block(),
...
-- INSERT-only trigger from 0022_divisions.sql. This migration replaces
-- that function directly (same name, so the existing trigger picks up the
-- new body automatically) rather than assuming 0024's objects exist.
--
-- Run this after 0026_fix_score_audit_log_fk.sql.
