...
-- unique(program_id, group_id) in 0005, program_group_participant_members'
-- composite FK in 0025) — rather than guess Postgres's auto-generated name,
-- this looks the actual constraint up via pg_constraint and drops it by
-- whatever name it actually has.
--
-- Run this after 0028_drop_unused_student_fields.sql.
...
-- pattern as 0022_divisions.sql, since group_program_results' shape
