...
-- division value — see 0006_program_category_is_division.sql) are both
...
--
-- Run this after 0021_program_judges.sql.
...
-- order — canonical definitions from 0016_student_category_on_results.sql
-- / 0013_dense_rank_ties.sql / 0011_group_leaderboard_points_by_type.sql /
-- 0019_event_top3_points.sql, unchanged except that p.category (used
