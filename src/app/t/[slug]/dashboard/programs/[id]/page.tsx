...
export default async function ProgramDetailPage({
  ...
  // supabase/migrations/20260829041027_group_multiple_teams.sql) — group entries by
        ...
        <TabsContent value="participants" className="mt-4">
          <Card className="card-elevated">
            <CardHeader>
              ...
              <CardAction>
                <Link
                  href={`/t/${slug}/dashboard/programs/${id}/roster`}
        ...
        <TabsContent value="scores" className="mt-4">
          <Card className="card-elevated">
            <CardHeader>
              ...
              <CardAction>
                <Link
                  href={`/t/${slug}/dashboard/programs/${id}/scoresheet`}
                  className="inline-flex items-center gap-1.5 rounded-lg border border-border px-3 py-2 text-sm font-medium text-muted-foreground transition-colors hover:border-primary hover:text-primary"
                >
                  <span className="material-symbols-outlined text-[18px]">print</span>
                  Print Judge Sheet
