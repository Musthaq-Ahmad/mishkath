  ...
  return (
    <header className="card-elevated relative flex shrink-0 flex-wrap items-center justify-between gap-3 overflow-hidden rounded-2xl border border-border bg-card px-4 py-3 sm:px-5">
      ...
      <div className="flex items-center gap-3">
        {/* The festival's own brand, not Fiestify's — this screen is what an
            audience sees. FestivalBrand handles the light/dark artwork swap,
            and falls back to the festival name when no logo is uploaded. */}
        <FestivalBrand {...brand} logoClassName="max-h-12 w-auto" nameClassName="text-2xl" />
      ...
      <div className="flex flex-wrap items-center gap-2 text-base sm:gap-3">
        ...
        <Link
          href={`/t/${tenantSlug}/leaderboard/results`}
